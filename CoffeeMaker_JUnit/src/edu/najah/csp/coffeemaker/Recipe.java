...
public class Recipe {
    ...
    public void setAmtChocolate(String chocolate) throws RecipeException {
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing amount of chocolate to integer ");
    	}
		if (amtChocolate >= 0) {
    ...
    public void setAmtCoffee(String coffee) throws RecipeException {
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing amount of coffee to integer ");    	}
		if (amtCoffee >= 0) {
    ...
    public void setAmtMilk(String milk) throws RecipeException{
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing amount of milk to integer ");    	}
		if (amtMilk >= 0) {
    ...
    public void setAmtSugar(String sugar) throws RecipeException {
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing amount of sugar to integer ");    	}
		if (amtSugar >= 0) {
    ...
    public void setPrice(String price) throws RecipeException{
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing amount of p to integer ");    	}
		if (amtPrice >= 0) {
			this.price = amtPrice;
		} else {
